          ...
          <div className="flex text-white items-center space-x-8">
            <motion.div whileHover={{ scale: 1.1, rotate: 5 }}>
              <button
                ...
                className="inline-flex focus:outline-none py-4 px-2 rounded-xl bg-gradient-to-r from-pink-300 via-yellow-400 to-orange-500 text-black shadow-lg hover:from-pink-600 hover:to-orange-600 transition-colors"
            ...
            <a
              href="/contact"
              className=" md:inline-flex items-center px-3 py-1 rounded-full font-semibold bg-gradient-to-r from-pink-500 via-yellow-400 to-orange-500 text-black shadow-lg hover:from-pink-600 hover:to-orange-600 transition-colors border-2 border-white/10 ml-2"
